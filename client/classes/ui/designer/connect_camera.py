...
"border-style: solid;")
        ...
        self.pushButton_reset.setMinimumSize(QtCore.QSize(150, 30))
        self.pushButton_reset.setMaximumSize(QtCore.QSize(150, 30))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(18)
        self.pushButton_reset.setFont(font)
        self.pushButton_reset.setStyleSheet("border-radius: 5px;\n"
"border-width: 2px;\n"
"border-color: rgb(0, 0, 0);\n"
"border-style: solid;")
        self.pushButton_reset.setFlat(False)
        self.pushButton_reset.setObjectName("pushButton_reset")
        self.horizontalLayout.addWidget(self.pushButton_reset, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_reset.setText(_translate("Dialog", "Abbrechen"))
