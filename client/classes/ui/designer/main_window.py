...
"border-width: 2px;")
        ...
        self.label_info_camera = QtWidgets.QLabel(self.groupBox_info_kamera)
        self.label_info_camera.setGeometry(QtCore.QRect(15, 15, 187, 29))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(14)
        self.label_info_camera.setFont(font)
        self.label_info_camera.setStyleSheet("border: none;\n"
"background-color: transparent;")
        self.label_info_camera.setObjectName("label_info_camera")
        self.label_info_camera_name = QtWidgets.QLabel(self.groupBox_info_kamera)
        self.label_info_camera_name.setGeometry(QtCore.QRect(210, 15, 186, 29))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(14)
        self.label_info_camera_name.setFont(font)
        self.label_info_camera_name.setStyleSheet("background-color: transparent;\n"
"border: none;\n"
"color: #DB2828;")
...
"border-width: 2px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_info_camera.setText(_translate("MainWindow", "Verbunden mit:"))
        self.label_info_camera_name.setText(_translate("MainWindow", "Nicht verbunden"))
